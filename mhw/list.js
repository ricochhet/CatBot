...
// DBs
const monsterListDatabase = require('../databases/lists/monsterlist.json');
const questListDatabase = require('../databases/lists/questlist.json');
const armorListDatabase = require('../databases/lists/armorlist.json');
const charmListDatabase = require('../databases/lists/charmlist.json');
  ...
  run (client, message, args) {
    ...
    switch (input) {
      ...
      case 'special':
        ...
        break;
      case 'arena':
          listEmbed.addField(questListDatabase["arenaQuests"].special1Title, questListDatabase["arenaQuests"].arena1);
          listEmbed.addField(questListDatabase["arenaQuests"].special2Title, questListDatabase["arenaQuests"].arena2);
          listEmbed.addField(questListDatabase["arenaQuests"].special4Title, questListDatabase["arenaQuests"].arena4);
          listEmbed.addField(questListDatabase["arenaQuests"].special6Title, questListDatabase["arenaQuests"].arena6);
          listEmbed.addField(questListDatabase["arenaQuests"].special7Title, questListDatabase["arenaQuests"].arena7);
          listEmbed.addField(questListDatabase["arenaQuests"].special8Title, questListDatabase["arenaQuests"].arena8);
        break;
      case 'ibassigned':
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special1Title, questListDatabase["iceborneAssignedQuests"].ibAssigned1);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special2Title, questListDatabase["iceborneAssignedQuests"].ibAssigned2);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special3Title, questListDatabase["iceborneAssignedQuests"].ibAssigned3);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special4Title, questListDatabase["iceborneAssignedQuests"].ibAssigned4);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special5Title, questListDatabase["iceborneAssignedQuests"].ibAssigned5);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special6Title, questListDatabase["iceborneAssignedQuests"].ibAssigned6);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special6PostTitle, questListDatabase["iceborneAssignedQuests"].ibAssigned6Post);
        break;
      case 'iboptional':
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special1Title, questListDatabase["iceborneAssignedQuests"].special1);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special2Title, questListDatabase["iceborneAssignedQuests"].special2);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special3Title, questListDatabase["iceborneAssignedQuests"].special3);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special4Title, questListDatabase["iceborneAssignedQuests"].special4);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special5Title, questListDatabase["iceborneAssignedQuests"].special5);
          listEmbed.addField(questListDatabase["iceborneAssignedQuests"].special6Title, questListDatabase["iceborneAssignedQuests"].special6);
        break;
      case 'lowrank':
